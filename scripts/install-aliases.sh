...
for name in \
    kafka-topics kafka-console-producer kafka-producer-perf-test kafka-e2e-latency kafka-verifiable-producer kafka-console-consumer kafka-consumer-perf-test kafka-console-share-consumer \
